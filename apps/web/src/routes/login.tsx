...
import { Link, type LoaderFunctionArgs, redirect, useLocation, useNavigate } from 'react-router';
                ...
                {!isSignUp && (
                  <div className="text-right">
                    <Link
                      ...
                      className="text-brand-400 text-sm transition-colors hover:text-brand-300"
                    >
