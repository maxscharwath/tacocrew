...
export function OrderListItem({
  ...
  return (
    ...
    >
      <article className="flex items-center gap-6 rounded-2xl border border-white/10 bg-slate-900/70 p-6 shadow-[0_20px_60px_rgba(8,47,73,0.25)] transition-all duration-200 hover:border-brand-400/40 hover:bg-slate-900/80 hover:shadow-[0_20px_60px_rgba(99,102,241,0.2)]">
        {/* Main Content */}
          ...
          <div className="min-w-0 flex-1">
            ...
            <div className="flex items-center gap-3 text-slate-400 text-sm">
              <div className="flex items-center gap-2">
                ...
                <span>{formatDateTimeRange(order.startDate, order.endDate)}</span>
              </div>
              {order.leader && (
                <>
        ...
        {order.participants?.length > 0 && (
          <div className="shrink-0 border-white/10 border-l pl-6">
            <StackedAvatars
        ...
        <div className="shrink-0">
          <div className="flex items-center justify-center rounded-xl border border-brand-400/30 bg-brand-500/10 p-3 transition-all duration-200 group-hover:border-brand-400/50 group-hover:bg-brand-500/20">
