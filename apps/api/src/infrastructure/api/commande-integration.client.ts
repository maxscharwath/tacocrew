    ...
    for (const option of group.options) {
      ...
      bucket[code] = existing
        ...
        : {
            ...
            in_stock: available,
            price,
            // Taco option groups don't carry their own images on commande.app;
            // fall back to the parent product image so meats/sauces/garnitures
            // at least share the Tacos card photo.
