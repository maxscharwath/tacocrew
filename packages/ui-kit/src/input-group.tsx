...
const inputGroupButtonVariants = cva(
  'text-sm shadow-none flex gap-2 items-center',
  {
    variants: {
      size: {
        xs: 'h-9 gap-1 px-3 rounded-xl [&>svg:not([class*=\'size-\'])]:size-4 has-[>svg]:px-2.5',
        sm: 'h-10 px-4 gap-1.5 rounded-xl has-[>svg]:px-3',
        'icon-xs': 'size-9 rounded-xl p-0 has-[>svg]:p-0',
